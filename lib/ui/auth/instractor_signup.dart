...
class InstractorSignUpScreen extends StatefulWidget {
  const InstractorSignUpScreen({Key? key}) : super(key: key);

  @override
  State<InstractorSignUpScreen> createState() => _InstractorSignUpScreenState();
}

class _InstractorSignUpScreenState extends State<InstractorSignUpScreen> {
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              const Text(
                'Create An Account As Instractor',
                style: TextStyle(
                    fontFamily: 'Poppins',
                    fontSize: 24,
